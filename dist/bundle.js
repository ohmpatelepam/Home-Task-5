...
eval("module.exports = __webpack_require__.p + \"05c6e0d20d8cf6ed5bb7c24ae04f70d9.jpg\";\n\n//# sourceURL=webpack:///./assets/errorimage.jpg?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"controller\", function() { return controller; });\n/* harmony import */ var _view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view.js */ \"./js/view.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\nvar controller = function controller(modelObj) {\n  var _this = this;\n\n  _classCallCheck(this, controller);\n\n  _defineProperty(this, \"getAll\", function () {\n    return _this.model.getAll();\n  });\n\n  _defineProperty(this, \"getAllKeys\", function () {\n    return _this.model.getAllKeys();\n  });\n\n  _defineProperty(this, \"removeLoader\", function () {\n    _this.model.removeLoader();\n  });\n\n  _defineProperty(this, \"loadHeadlineFile\", function () {\n    _this.loadScript();\n  });\n\n  _defineProperty(this, \"loadScript\", function () {\n    var isLoaded = document.querySelectorAll(\"#headline-myModal\");\n\n    if (isLoaded.length > 0) {\n      _this.headline.init();\n\n      return;\n    }\n\n    Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! ./headline.js */ \"./js/headline.js\")).then(function (module) {\n      _this.headline = new module.headline();\n    });\n  });\n\n  this.model = modelObj;\n  this.view = new _view_js__WEBPACK_IMPORTED_MODULE_0__[\"view\"](this);\n  this.headline = undefined;\n};\n\n//# sourceURL=webpack:///./js/controller.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"headline\", function() { return headline; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\nvar headline = function headline() {\n  var _this = this;\n\n  _classCallCheck(this, headline);\n\n  _defineProperty(this, \"init\", function () {\n    _this.data = [];\n\n    _this.showPopUP();\n\n    _this.initializeLoader();\n\n    _this.fetchHeadlines();\n  });\n\n  _defineProperty(this, \"fetchHeadlines\",\n  /*#__PURE__*/\n  _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee() {\n    var _this2 = this;\n\n    var response;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.next = 2;\n            return fetch(\"https://newsapi.org/v2/top-headlines?country=us&apiKey=d4e03df5989c4e4a998e4fb2fe632d48\").then(function (result) {\n              return result.json();\n            }).then(function (jsonres) {\n              return _this2.set(jsonres);\n            })[\"catch\"](function () {\n              alert(\"Cannot able to fetch data\");\n            });\n\n          case 2:\n            response = _context.sent;\n            this.showData();\n            this.removeLoader();\n\n          case 5:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this);\n  })));\n\n  _defineProperty(this, \"set\", function (data1) {\n    data1.articles.forEach(function (element) {\n      var tempData = {\n        title: element.title,\n        description: element.description\n      };\n\n      _this.data.push(tempData);\n    });\n  });\n\n  _defineProperty(this, \"showData\", function () {\n    if (_this.data.length === 0) {\n      alert(\"data array is empty\");\n      return;\n    }\n\n    document.getElementById(\"headline-modal-header\").innerHTML = \"Headlines\";\n\n    _this.data.forEach(function (element) {\n      var title = _this.createElement(\"h3\", \"\", \"headline-modal-title\");\n\n      var description = _this.createElement(\"p\", \"\", \"headline-modal-para\");\n\n      var breakline = _this.createElement(\"hr\", \"\", \"\");\n\n      title.innerHTML = element.title;\n      description.innerHTML = element.description;\n      document.getElementById(\"headline-modal-body\").appendChild(title);\n      document.getElementById(\"headline-modal-body\").appendChild(description);\n      document.getElementById(\"headline-modal-body\").appendChild(breakline);\n    });\n\n    document.getElementById(\"headline-myModal\").style.display = \"block\";\n  });\n\n  _defineProperty(this, \"initializeLoader\", function () {\n    var body = document.getElementById(\"headline-modal-content\");\n\n    var loaderDiv = _this.createElement(\"div\", \"\", \"headline-loader\");\n\n    body.appendChild(loaderDiv);\n  });\n\n  _defineProperty(this, \"removeLoader\", function () {\n    document.getElementById(\"headline-loader\").style.display = \"none\";\n  });\n\n  _defineProperty(this, \"createPopUp\", function () {\n    var parent = document.getElementById(\"heading\");\n\n    var modal = _this.createElement(\"div\", \"modal\", \"headline-myModal\");\n\n    parent.appendChild(modal);\n\n    var modal_content = _this.createElement(\"div\", \"modal-content\", \"headline-modal-content\");\n\n    modal.appendChild(modal_content);\n\n    var modal_header = _this.createElement(\"div\", \"modal-header\", \"\");\n\n    modal_content.appendChild(modal_header);\n\n    var close = _this.createElement(\"span\", \"close\", \"\");\n\n    close.onclick = function () {\n      modal.style.display = \"none\";\n    };\n\n    close.innerHTML = \"&times\";\n    modal_header.appendChild(close);\n\n    var heading = _this.createElement(\"h2\", \"\", \"headline-modal-header\");\n\n    modal_header.appendChild(heading);\n\n    var modal_body = _this.createElement(\"div\", \"\", \"headline-modal-body\");\n\n    modal_content.appendChild(modal_body);\n  });\n\n  _defineProperty(this, \"createElement\", function (type, classname, id) {\n    var element = document.createElement(type);\n    element.className = classname || \"\";\n    element.id = id || \"\";\n    return element;\n  });\n\n  _defineProperty(this, \"showPopUP\", function () {\n    document.getElementById(\"headline-myModal\").style.display = \"block\";\n  });\n\n  this.data = undefined;\n  this.createPopUp();\n  this.init();\n};\n\n//# sourceURL=webpack:///./js/headline.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"view\", function() { return view; });\n/* harmony import */ var _assets_errorimage_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/errorimage.jpg */ \"./assets/errorimage.jpg\");\n/* harmony import */ var _assets_errorimage_jpg__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_assets_errorimage_jpg__WEBPACK_IMPORTED_MODULE_0__);\nfunction _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _nonIterableRest(); }\n\nfunction _nonIterableRest() { throw new TypeError(\"Invalid attempt to destructure non-iterable instance\"); }\n\nfunction _iterableToArrayLimit(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i[\"return\"] != null) _i[\"return\"](); } finally { if (_d) throw _e; } } return _arr; }\n\nfunction _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }\n\n\nvar view = //Helper function to setup\nfunction view(controller) {\n  var _this = this;\n\n  _classCallCheck(this, view);\n\n  _defineProperty(this, \"init\", function () {\n    _this.setupHeader();\n\n    _this.setupFooter();\n\n    _this.setupMain();\n\n    _this.cntrl.removeLoader();\n  });\n\n  _defineProperty(this, \"setupFooter\", function () {\n    var h1 = _this.createElement(\"h1\", \"footer1\", \"\");\n\n    h1.innerHTML = \" © NewsFeed 2019\";\n    document.getElementById(\"footer\").appendChild(h1);\n  });\n\n  _defineProperty(this, \"setupHeader\", function () {\n    var h1 = _this.createElement(\"h2\", \"\", \"head\");\n\n    h1.innerHTML = \"NEWSFEED <span class=\" + \"subhead\" + \"> Yet another Newsfeed </span>\";\n    document.getElementById(\"heading\").appendChild(h1);\n\n    var input = _this.createElement(\"input\", \"\", \"input\");\n\n    input.type = \"text\";\n    input.placeholder = \" Email Address\";\n    document.getElementById(\"heading\").appendChild(input);\n\n    var subscribe_button = _this.createElement(\"button\", \"\", \"subscribe-button\");\n\n    subscribe_button.innerHTML = \"Subscribe\";\n    subscribe_button.addEventListener(\"click\", _this.validateEmail);\n    document.getElementById(\"heading\").appendChild(subscribe_button);\n  });\n\n  _defineProperty(this, \"setupMain\", function () {\n    var main_tag = document.getElementById(\"main_content\");\n\n    _this.createAside(main_tag);\n\n    _this.createContentDiv(main_tag);\n\n    _this.createPopUp();\n  });\n\n  _defineProperty(this, \"createAside\", function (parent_node) {\n    var aside = _this.createElement(\"aside\", \"\", \"\");\n\n    parent_node.appendChild(aside);\n\n    var category = _this.createElement(\"p\", \"\", \"\");\n\n    category.innerHTML = \"SELECT CATEGORY\";\n    category.style.fontStyle = \"bold\";\n    aside.appendChild(category);\n\n    var newList = _this.createElement(\"select\", \"\", \"dropdown\");\n\n    newList.addEventListener(\"change\", _this.setupdropdown);\n    newList.appendChild(new Option(\"All\", \"all\"));\n\n    var data = _this.cntrl.getAllKeys();\n\n    var _iteratorNormalCompletion = true;\n    var _didIteratorError = false;\n    var _iteratorError = undefined;\n\n    try {\n      for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n        var key = _step.value;\n        newList.appendChild(new Option(key, key));\n      }\n    } catch (err) {\n      _didIteratorError = true;\n      _iteratorError = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion && _iterator[\"return\"] != null) {\n          _iterator[\"return\"]();\n        }\n      } finally {\n        if (_didIteratorError) {\n          throw _iteratorError;\n        }\n      }\n    }\n\n    aside.appendChild(newList);\n\n    var error_text = _this.createElement(\"p\", \"\", \"error_text\");\n\n    error_text.innerHTML = \"\";\n    aside.appendChild(error_text);\n\n    var headlines = _this.createElement(\"button\", \"\", \"headline-button\");\n\n    headlines.innerHTML = \"Headlines\";\n\n    headlines.onclick = function () {\n      _this.cntrl.loadHeadlineFile();\n    };\n\n    aside.appendChild(headlines);\n  });\n\n  _defineProperty(this, \"createContentDiv\", function (parent_node) {\n    window.Content_Div = _this.createElement(\"div\", \"content-div\", \"\");\n    parent_node.appendChild(window.Content_Div);\n    window.Content_Div.innerHTML = \"\";\n\n    _this.showAllChannels(Content_Div);\n  });\n\n  _defineProperty(this, \"createInsideDiv\", function (parent_node, key, v) {\n    var inside_div = _this.createElement(\"div\", \"inside-div\", \"\");\n\n    parent_node.appendChild(inside_div);\n\n    var img = _this.createElement(\"img\", \"img\", \"\");\n\n    img.src = v.imageurlText == null ? _assets_errorimage_jpg__WEBPACK_IMPORTED_MODULE_0___default.a : v.imageurlText;\n    inside_div.appendChild(img);\n\n    var h1 = _this.createElement(\"h1\", \"title\", \"news_title\");\n\n    h1.innerHTML = v.sourceText;\n    h1.title = v.sourceText;\n    inside_div.appendChild(h1);\n\n    var p = _this.createElement(\"p\", \"subscript\", \"\");\n\n    p.innerHTML = \"<span class=\\\" + \\\"posted\\\" + \\\">Posted on: </span> \".concat(v.dateText, \" <span class=\\\" + \\\"posted\\\" + \\\">// Author: </span> \").concat(v.authorText);\n    inside_div.appendChild(p);\n\n    var lorem = _this.createElement(\"p\", \"lorem\", \"\");\n\n    lorem.innerHTML = v.contentText != null ? v.contentText : v.descriptionText;\n    lorem.appendChild(_this.createElement(\"br\", \"\", \"\"));\n    inside_div.appendChild(lorem);\n\n    var Continue_reading_button = _this.createElement(\"button\", \"button\", \"\");\n\n    Continue_reading_button.innerHTML = \"Continue Reading\";\n    Continue_reading_button.addEventListener(\"click\", function () {\n      _this.showPopUP(key, v);\n    });\n    inside_div.appendChild(Continue_reading_button);\n    parent_node.appendChild(document.createElement(\"hr\"));\n  });\n\n  _defineProperty(this, \"createPopUp\", function () {\n    var parent = document.getElementById(\"heading\");\n\n    var modal = _this.createElement(\"div\", \"modal\", \"myModal\");\n\n    parent.appendChild(modal);\n\n    var modal_content = _this.createElement(\"div\", \"modal-content\", \"\");\n\n    modal.appendChild(modal_content);\n\n    var modal_header = _this.createElement(\"div\", \"modal-header\", \"\");\n\n    modal_content.appendChild(modal_header);\n\n    var close = _this.createElement(\"span\", \"close\", \"\");\n\n    close.onclick = function () {\n      modal.style.display = \"none\";\n    };\n\n    close.innerHTML = \"&times\";\n    modal_header.appendChild(close);\n\n    var heading = _this.createElement(\"h2\", \"\", \"modal-header\");\n\n    modal_header.appendChild(heading);\n\n    var modal_body = _this.createElement(\"div\", \"\", \"modal-body\");\n\n    modal_content.appendChild(modal_body);\n\n    var para = _this.createElement(\"p\", \"\", \"modal-para\");\n\n    modal.style.display = \"none\";\n    modal_body.appendChild(para);\n  });\n\n  _defineProperty(this, \"showAllChannels\", function (Content_Div) {\n    Content_Div.innerHTML = \"\";\n\n    var data = _this.cntrl.getAll();\n\n    var _iteratorNormalCompletion2 = true;\n    var _didIteratorError2 = false;\n    var _iteratorError2 = undefined;\n\n    try {\n      for (var _iterator2 = data[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {\n        var _step2$value = _slicedToArray(_step2.value, 2),\n            key = _step2$value[0],\n            val = _step2$value[1];\n\n        var _iteratorNormalCompletion3 = true;\n        var _didIteratorError3 = false;\n        var _iteratorError3 = undefined;\n\n        try {\n          for (var _iterator3 = val[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {\n            var v = _step3.value;\n\n            _this.createInsideDiv(Content_Div, key, v);\n          }\n        } catch (err) {\n          _didIteratorError3 = true;\n          _iteratorError3 = err;\n        } finally {\n          try {\n            if (!_iteratorNormalCompletion3 && _iterator3[\"return\"] != null) {\n              _iterator3[\"return\"]();\n            }\n          } finally {\n            if (_didIteratorError3) {\n              throw _iteratorError3;\n            }\n          }\n        }\n      }\n    } catch (err) {\n      _didIteratorError2 = true;\n      _iteratorError2 = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion2 && _iterator2[\"return\"] != null) {\n          _iterator2[\"return\"]();\n        }\n      } finally {\n        if (_didIteratorError2) {\n          throw _iteratorError2;\n        }\n      }\n    }\n  });\n\n  _defineProperty(this, \"showSpecificChannel\", function (option) {\n    var news_channel = option;\n    window.Content_Div.innerHTML = \"\";\n\n    var arr = _this.cntrl.getAll().get(news_channel);\n\n    var _iteratorNormalCompletion4 = true;\n    var _didIteratorError4 = false;\n    var _iteratorError4 = undefined;\n\n    try {\n      for (var _iterator4 = arr[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {\n        var v = _step4.value;\n\n        _this.createInsideDiv(window.Content_Div, news_channel, v);\n      }\n    } catch (err) {\n      _didIteratorError4 = true;\n      _iteratorError4 = err;\n    } finally {\n      try {\n        if (!_iteratorNormalCompletion4 && _iterator4[\"return\"] != null) {\n          _iterator4[\"return\"]();\n        }\n      } finally {\n        if (_didIteratorError4) {\n          throw _iteratorError4;\n        }\n      }\n    }\n  });\n\n  _defineProperty(this, \"setupdropdown\", function () {\n    var e = document.getElementById(\"dropdown\");\n    var option = e.options[e.selectedIndex].value;\n    option != \"all\" ? _this.showSpecificChannel(option) : _this.showAllChannels(window.Content_Div);\n  });\n\n  _defineProperty(this, \"validateEmail\", function () {\n    var email = document.getElementById(\"input\").value;\n    var error_text_field = document.getElementById(\"error_text\");\n    error_text_field.style.visibility = \"visible\";\n\n    if (/^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$/.test(email)) {\n      var emails = JSON.parse(localStorage.getItem(\"email\"));\n\n      if (emails == null) {\n        emails = [];\n      }\n\n      if (emails.includes(email)) {\n        error_text_field.innerHTML = \"Email Already Exist..!\";\n        error_text_field.style.backgroundColor = \"yellow\";\n        error_text_field.style.visibility = \"visible\";\n        document.getElementById(\"input\").value = \"\";\n        setTimeout(_this.Clear, 1000);\n        return;\n      }\n\n      emails.push(email);\n      localStorage.setItem(\"email\", JSON.stringify(emails));\n      error_text_field.innerHTML = \"Email Saved\";\n      error_text_field.style.backgroundColor = \"Green\";\n      error_text_field.style.visibility = \"visible\";\n      document.getElementById(\"input\").value = \"\";\n      setTimeout(_this.Clear, 1000);\n      return;\n    }\n\n    error_text_field.innerHTML = \"Email Wrong\";\n    error_text_field.style.backgroundColor = \"red\";\n    setTimeout(_this.Clear, 1000);\n  });\n\n  _defineProperty(this, \"showPopUP\", function (key, v) {\n    var full_news = v.contentText != null ? v.contentText : v.descriptionText;\n    document.getElementById(\"modal-para\").innerHTML = full_news;\n    document.getElementById(\"modal-header\").innerHTML = key;\n    document.getElementById(\"myModal\").style.display = \"block\";\n  });\n\n  _defineProperty(this, \"Clear\", function () {\n    document.getElementById(\"error_text\").style.visibility = \"hidden\";\n  });\n\n  _defineProperty(this, \"createElement\", function (type, classname, id) {\n    var element = document.createElement(type);\n    element.className = classname || \"\";\n    element.id = id || \"\";\n    return element;\n  });\n\n  this.cntrl = controller;\n  this.init();\n};\n\n//# sourceURL=webpack:///./js/view.js?");
...
eval("var content = __webpack_require__(/*! !../node_modules/css-loader/dist/cjs.js!./style.css */ \"./node_modules/css-loader/dist/cjs.js!./static/style.css\");\n\nif (typeof content === 'string') {\n  content = [[module.i, content, '']];\n}\n\nvar options = {}\n\noptions.insert = \"head\";\noptions.singleton = false;\n\nvar update = __webpack_require__(/*! ../node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js */ \"./node_modules/style-loader/dist/runtime/injectStylesIntoStyleTag.js\")(content, options);\n\nif (content.locals) {\n  module.exports = content.locals;\n}\n\n\n//# sourceURL=webpack:///./static/style.css?");

/***/ }),

/***/ 0:
/*!*************************************************************************!*\
  !*** multi whatwg-fetch @babel/polyfill ./js/index.js ./js/headline.js ***!
  \*************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! whatwg-fetch */\"./node_modules/whatwg-fetch/fetch.js\");\n__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\n__webpack_require__(/*! ./js/index.js */\"./js/index.js\");\nmodule.exports = __webpack_require__(/*! ./js/headline.js */\"./js/headline.js\");\n\n\n//# sourceURL=webpack:///multi_whatwg-fetch_@babel/polyfill_./js/index.js_./js/headline.js?");
